...
extern aclnnStatus aclnnInnerDispatchFFNCombineGetWorkspaceSize(
    ...
    int64_t epRankId, int64_t maxOutputSize, bool transB, bool weightNz, int64_t activationType, float beta,
    float linearBeta, bool enableLinearBeta, const aclTensor *out, const aclTensor *expertTokenNums,
...
aclnnStatus aclnnDispatchFFNCombineGetWorkspaceSize(const aclTensor *x, const aclTensor *weight1,
                                                    ...
                                                    float beta, float linearBeta, bool enableLinearBeta,
