#ifndef DEEPEP_PROFILING_ADAPTERS_MOE_LOW_LATENCY_DISPATCH_V2_A5_PROFILE_TRAITS_HPP
#define DEEPEP_PROFILING_ADAPTERS_MOE_LOW_LATENCY_DISPATCH_V2_A5_PROFILE_TRAITS_HPP
...
static_assert(kStageCount <= Cam::PROFILE_ACTIVE_STAGE_CAPACITY,
              "moe_low_latency_dispatch_v2_a5 stage count must fit in active profiling stage capacity");
...
#endif  // DEEPEP_PROFILING_ADAPTERS_MOE_LOW_LATENCY_DISPATCH_V2_A5_PROFILE_TRAITS_HPP
